...
public interface PreviousExperienceRepository
	...
	@Query(value = "select * from previous_experience where emp_code=:empCode", nativeQuery = true)
	public List<PreviousExperience> findByEmpCode(@Param("empCode") String empCode);
