...
export class AdminMasterDataComponent implements OnInit {
  ...
  postHolidayList() {
    this.adminService
      .postHolidayList(this.holidayListName)
      .subscribe((data: any) => {
  ...
  getAllEmpManagerList() {
    this.adminService.getAllEmpManagerList().subscribe((data: any) => {
      console.log("Manager emp list", data);
      this.empManagerData=data;
    });
  }

  empManagerSelection(code){
    console.log("manager code",code)
    this.createEmployee.managerCode=code;
  }
  employeeCreation() {
    this.getAllEmpManagerList();
  ...
  postEmployeeCreation() {
    this.adminService
      .createEmployeeInfo(this.createEmployee)
      .subscribe((data: any) => {
